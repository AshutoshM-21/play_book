...
import 'package:play_book/pages/result_list.dart';
import 'package:play_book/widgets/book_list_tile.dart';
        ...
        child: Container(
          ...
          decoration: BoxDecoration(boxShadow: [
            const BoxShadow(
                ...
                blurRadius: 10,
                offset: Offset(0, 5))
          ], borderRadius: BorderRadius.circular(32), color: const Color(0xffF5F5F5)),
          child: const Row(
            children: <Widget>[
              Icon(
                Icons.search,
